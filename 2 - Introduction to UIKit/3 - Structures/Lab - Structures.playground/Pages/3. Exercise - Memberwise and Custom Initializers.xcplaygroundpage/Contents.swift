...
let favoriteBook = Book(title: "xyz",author:"abc",pages:12,price: 90.00)
print("book title is \(favoriteBook.title) by \(favoriteBook.author) with pages \(favoriteBook.pages)and cost is \(favoriteBook.price)")
...
var hp = Laptop(yearPurchased: 2025)
var dell = Laptop(repairCount: 1 ,yearPurchased: 2024)

print("hp screen size is \(hp.screenSize) and repair count is \(hp.repairCount) and purchased year is \(hp.yearPurchased)")
print("dell screen size is \(dell.screenSize) and repair count is \(dell.repairCount) and purchased year is \(dell.yearPurchased)")
...
struct Height {
    ...
    init(inches: Double){
        ...
        print("height in inches is \(inches) and height in centimeters is \(inches * 2.54)")
    }
    init(centimeters: Double){
        self.heightInCentimeters = centimeters
        self.heightInInches = centimeters / 2.54
        
        print("height in inches is \(centimeters / 2.54) and height in centimeters is \(centimeters)")
    }
}
let i1 = Height(inches: 65)
let i2 = Height(centimeters: 50)
