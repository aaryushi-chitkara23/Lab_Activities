...
struct User {
    ...
    var email: String
    var age: Int
    static var currentUser = User(userName: "Aaryushi", email:"aaryushi1588.be23@chitkara.edu.in", age: 19)
 ...
 */
let newUser = User(userName: "aaryushi", email: "aaryushi@gmail.com", age: 20)
