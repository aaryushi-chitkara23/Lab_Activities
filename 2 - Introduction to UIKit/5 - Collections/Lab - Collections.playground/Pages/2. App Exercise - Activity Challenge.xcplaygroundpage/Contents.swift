 ...
 */
var list1 : [String] = ["walk 10 km", "speed walk"]
var list2 : [String] = ["run 10 km", "5km run"]
var list3 : [String] = ["asana 1", "asana 2"]
...
var challenges = [list1, list2 , list3]
...
var newArray : [String] = ["walking","running","swimming"]
...
if newArray.isEmpty{
    ...
    print("the challenge you have chosen \(newArray[0])")
}
else{
